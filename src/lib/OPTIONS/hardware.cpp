...
static const struct {
    ...
    {HARDWARE_led_rgb_status, "led_rgb_status", ARRAY},
    {HARDWARE_led_rgb_status_count, "led_rgb_status", COUNT},
    {HARDWARE_led_rgb_vtx, "led_rgb_vtx", ARRAY},
    {HARDWARE_led_rgb_vtx_count, "led_rgb_vtx", COUNT},
    {HARDWARE_led_rgb_boot, "led_rgb_boot", ARRAY},
    {HARDWARE_led_rgb_boot_count, "led_rgb_boot", COUNT},
